...
| Date (UTC)       | Change                              |
|------------------|-------------------------------------|
| 2026-05-12 09:40 | Initial GitHub issue created (#7)   |
| 2026-05-12 11:05 | Updated: title, body                |
<!-- github-sync-changelog-end -->
```

If the epic already has a hand-written `## Change Log` heading without HTML markers, the first sync wraps it in markers in place and preserves any existing `| date | change |` rows.
