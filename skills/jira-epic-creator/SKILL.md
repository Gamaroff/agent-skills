...
```bash
node .scripts/jira-create-epic.js --file "$PRD_ROOT/[domain]/[feature]/epics/epic.[N].[name]/epic.[N].[name].md"
```
...
```bash
node .scripts/jira-create-epic.js --file "$PRD_ROOT/.../epic.N.name.md" --dry-run
```
