...
```bash
node scripts/sync-jira-task.js --probe-workflow
```
...
```json
{
  ...
  "jira_key": "PROJ-47",
  "jira_url": "https://yourorg.atlassian.net/browse/PROJ-47",
  "task_bitbucket_url": "https://bitbucket.org/org/repo/src/main/docs/tasks/task.47.../task.47....md",
...
link (see [Why document links are relative](./SKILL.md#why-document-links-are-relative)).
