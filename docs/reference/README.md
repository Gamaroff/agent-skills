...
> **Audience:** developers looking up specific behaviour.

Spec-style documents to consult when you need a fact, not a walkthrough.
...
- [Standards](../standards/README.md) — document schemas
- [Operations / Workflows](../operations/workflows.md) — pipeline chains
