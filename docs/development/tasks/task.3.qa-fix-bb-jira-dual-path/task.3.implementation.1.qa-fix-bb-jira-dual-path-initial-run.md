...
- review-task skipped — task status is `Ready for Development` and review report exists at `docs/development/tasks/task.3.qa-fix-bb-jira-dual-path/task.3.qa-fix-bb-jira-dual-path.review.2026-05-05.md`
