...
- **Task File:** `docs/development/tasks/task.6.create-epic-jira-tracker-path/task.6.create-epic-jira-tracker-path.md`
- **Plan File:** `docs/development/tasks/task.6.create-epic-jira-tracker-path/task.6.plan.create-epic-jira-tracker-path.md`
