...
- `docs/development/tasks/task.17.../task.17.develop-loop-iteration-audit-subagent.md` — task doc
- `docs/development/tasks/task.17.../task.17.plan.develop-loop-iteration-audit-subagent.md` — plan
