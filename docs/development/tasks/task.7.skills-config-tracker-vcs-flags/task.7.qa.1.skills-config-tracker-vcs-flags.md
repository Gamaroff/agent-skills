...
- `docs/development/tasks/task.7.skills-config-tracker-vcs-flags/task.7.skills-config-tracker-vcs-flags.md` — checkboxes, status
- `docs/development/tasks/task.7.skills-config-tracker-vcs-flags/task.7.plan.skills-config-tracker-vcs-flags.md` — review fixes applied
