...
- `docs/development/tasks/task.30.../task.30.develop-task-pipeline-resume-stale-context-detector.md` — task document
- `docs/development/tasks/task.30.../task.30.plan.*.md` — plan file
