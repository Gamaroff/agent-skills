...
- **Review Depth:** Standard
- **Task File:** `docs/tasks/task.32.evals-reorganize-per-skill/task.32.evals-reorganize-per-skill.md`
- **Plan File:** `docs/tasks/task.32.evals-reorganize-per-skill/task.32.plan.evals-reorganize-per-skill.md`
