...
| 71 | [Make the selection floor equal what the dispatching pipeline accepts](task.71.selection-floor-matches-dispatcher/task.71.selection-floor-matches-dispatcher.md) | ready-for-review | infrastructure | High | 2026-08-31 | [#285](https://github.com/Gamaroff/agent-skills/issues/285) | task.66 |
