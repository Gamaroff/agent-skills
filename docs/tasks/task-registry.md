...
| 36 | [Stop setup-consumer.sh generating a jira.statusMap that disables status syncing](task.36.setup-consumer-statusmap-fix/task.36.setup-consumer-statusmap-fix.md) | ready-for-development | refactoring | High | 2026-08-03 | [#184](https://github.com/Gamaroff/agent-skills/issues/184) | — |
| 37 | [tracker-workflow.yaml — a consumer-owned status ladder the pipelines read](task.37.tracker-workflow-config-engine/task.37.tracker-workflow-config-engine.md) | planned | infrastructure | High | 2026-08-03 | [#185](https://github.com/Gamaroff/agent-skills/issues/185) | — |
