...
- **Review Depth:** Standard
- **Task File:** `docs/tasks/task.1.extract-shared-develop-pipeline-body/task.1.extract-shared-develop-pipeline-body.md`
- **Plan File:** `docs/tasks/task.1.extract-shared-develop-pipeline-body/task.1.plan.extract-shared-develop-pipeline-body.md`
