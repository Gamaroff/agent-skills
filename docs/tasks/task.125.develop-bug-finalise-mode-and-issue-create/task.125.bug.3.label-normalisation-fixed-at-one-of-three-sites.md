...
**Verification Notes**: one shared gh-labels.sh normalisation, guard green.
...
| 2026-09-21 | Closed | QA Engineer | Fix verified in QA cycle 2 — one shared gh-labels.sh normalisation, guard green |
