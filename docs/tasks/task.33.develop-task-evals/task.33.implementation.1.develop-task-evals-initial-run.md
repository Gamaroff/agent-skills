...
- review-task skipped — task status is `ready-for-development` and review report exists at `docs/tasks/task.33.develop-task-evals/task.33.review.1.develop-task-evals.md`
...
- Plan file found: `docs/tasks/task.33.develop-task-evals/task.33.plan.develop-task-evals.md` — included as implementation context for /develop
...
**DoD Summary**: docs/tasks/task.33.develop-task-evals/task.33.dod.1.develop-task-evals.md
