...
- `docs/tasks/task.12.document-status-lifecycle/task.12.document-status-lifecycle.md`
...
- `docs/tasks/task.12.document-status-lifecycle/task.12.document-status-lifecycle.md` (self-migration of frontmatter)
