...
Story dev notes (edge cases) state: "Registry pollution risk doubles: both `docs/development/epic-registry.md` AND `docs/tasks/task-registry.md` ... Cleanup section must address both."
