...
vocabulary is frozen in `VERDICTS` (`shared/resources/security-probe.mjs`) — never invent a fifth:
...
You never write a verdict field yourself. `runProbeSpec` (`shared/resources/security-probe.mjs`)
