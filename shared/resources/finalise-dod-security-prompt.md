...
down once, in [`shared/resources/security-input-corpus.md`](security-input-corpus.md) and its
machine-readable peer `shared/resources/security-input-corpus.mjs`. Start there rather than
